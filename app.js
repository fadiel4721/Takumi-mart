 ...
 */
mongoose.connect("mongodb://localhost:27017/db_Takumi-mart", {
...
//mengambil fungsi route yang sama
const takumiRouter = require('./routes/takumi');
var app = express();
...
//menggunakan routes takumi
app.use('/takumi', takumiRouter);
